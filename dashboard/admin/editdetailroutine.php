...
<head>
  ...
  <tr>
    ...
    <td height="87" colspan="2"><input type="text" name='routinename' value='<?php echo $rname ?>'></td>
    </tr>
  <tr>
    <td width="186" height="103">Day 1:</td>
    <td width="417"><textarea style="resize:none; margin: 0px; width: 230px; height: 53px;" name="day1" id="boxxe" ><?php echo $day1 ?></textarea></td>
  </tr>
  <tr>
    <td height="96">Day 2:</td>
    <td><textarea style="resize:none; margin: 0px; width: 230px; height: 53px;" name="day2" id="boxxe" ><?php echo $day2 ?></textarea></td>
  </tr>
  <tr>
    <td height="87">Day 3:</td>
    <td><textarea style="resize:none; margin: 0px; width: 230px; height: 53px;"  name="day3" id="boxxe" ><?php echo $day3 ?></textarea></td>
  </tr>
  <tr>
    <td height="92">Day 4:</td>
    <td><textarea style="resize:none; margin: 0px; width: 230px; height: 53px;"  name="day4" id="boxxe" ><?php echo $day4 ?></textarea></td>
  </tr>
  <tr>
    <td height="84">Day 5:</td>
    <td><textarea style="resize:none; margin: 0px; width: 230px; height: 53px;"  name="day5" id="boxxe" ><?php echo $day5 ?></textarea></td>
  </tr>
  <tr>
    <td height="75">Day 6:</td>
    <td><textarea style="resize:none; margin: 0px; width: 230px; height: 53px;"  name="day6" id="boxxe" ><?php echo $day6 ?></textarea></td>
  </tr>
  <tr>
               <td height="35">&nbsp;</td>
               <td height="35">
