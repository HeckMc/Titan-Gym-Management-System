...
<ul id="main-menu" class="" >
	...
	<li id="paymnt"><a href="payments.php"><i class="entypo-star"></i><span>Make Payments</span></a></li>
	
	<li id="paymnt"><a href="payment_history.php"><i class="entypo-star"></i><span>Payment History</span></a></li>

	<li class="" id="hassubopen"><a href="#" onclick="memberExpand(1)"><i class="entypo-users"></i><span>Members</span></a>
		<ul id="memExpand">
			<li class="active">
			<li><a href="table_view.php"><span>View Memeber Details</span></a></li>
		</ul>
	</li>
	...
	<li class="" id="planhassubopen"><a href="#" onclick="memberExpand(2)"><i class="entypo-quote"></i><span>Plan</span></a>
		...
		<ul id="planExpand">
			...
			<li><a href="view_plan.php"><span>Edit Plan Details</span></a></li>
		</ul>
